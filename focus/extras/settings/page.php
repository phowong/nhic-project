<div class="wrap">
	...
	<h2 id="theme-settings-title">
		...
		<?php printf(__( '%s Theme Settings', 'focus' ), $theme->get('Name')) ?>
	</h2>
	...
	<form action="options.php" method="post" id="siteorigin-settings-form">
		...
		<p class="submit">
			<input name="Submit" type="submit" class="button-primary" value="<?php esc_attr_e('Save Settings', 'focus'); ?>" id="siteorigin-settings-submit" />
			<a href="http://siteorigin.com/threads/theme-<?php echo get_template() ?>/" target="_blank" id="siteorigin-theme-support"><?php _e( 'Theme Support Forum', 'focus' ) ?></a>
		</p>
